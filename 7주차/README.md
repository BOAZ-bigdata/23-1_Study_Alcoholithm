...
- 모든 경우의 수에서 가능할까? yes!
- `트로미노 타일링`이라는 유명 문제로, 수학적 귀납법을 통해 배수구로 사용되는 한 칸을 제외하고 2의 제곱수를 한 변의 길이로 가지는 어떤 정사각 평면에서도 트로미노를 이용하여 평면을 채울 수 있다고 증명할 수 있다.
...
- area를 다음과 같은 숫자로 영역을 구분하여 각각 재귀로 계속한다.
  0 1
  2 3
